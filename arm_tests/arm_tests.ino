...
//= {3.6806,-1.432,1.1434,1.3912,1.6986,-19.0847,21.975}; {-2.4885,-0.20436,0.54144,0.11204,-0.4336,-7.259,8.8801}; //{0.068796,-0.041852,0.50591,0.28639,-0.39691,-6.1495,3.9878};    //vector of parameters definitions obtained after LS calibration function
