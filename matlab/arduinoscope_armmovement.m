...
cont_high=400;
percent_high=95;
xmax=800; %8000 Para 10 iterations % 2400 3
...
angle_value(i,1)=str2double(out(commas(2)+1:commas(3)-1));
%vref_mean(i,1)=str2double(out(commas(4)+1:commas(5)-1));
...
%     axis([0 xmax vim_ymin vim_ymax]);
    ...
    subplot(2,1,1)
    plot(angle_value(end-11*sign(end-11):end),PWM_value(end-11*sign(end-11):end),'LineWidth',2)
